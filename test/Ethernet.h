...
public:
    ...
    void begin(uint16_t port)
    {
        ...
        byte rejectedWithoutSessionName[] = { 0xff, 0xff, 0x4e, 0x4f, 0x00, 0x00, 0x00, 0x02, 0x71, 0xd9, 0x10, 0x62, 0xbd, 0xea, 0xaf, 0xe8 };
        byte rejectedWithSessionName[] = { 0xff, 0xff, 0x4e, 0x4f, 0x00, 0x00, 0x00, 0x02, 0x71, 0xd9, 0x10, 0x62, 0xbd, 0xea, 0xaf, 0xe8, 'a', 0x00 };
        byte rejectedWithIncompleteSessionName[] = { 0xff, 0xff, 0x4e, 0x4f, 0x00, 0x00, 0x00, 0x02, 0x71, 0xd9, 0x10, 0x62, 0xbd, 0xea, 0xaf, 0xe8, 'a', 'b' };

        
        if (port == 5004 && true)
        {
     //       write(rejectedWithIncompleteSessionName, sizeof(rejectedWithIncompleteSessionName));
            // AppleMIDI messages
        }
        ...
        byte aa[] = {
           ...
           byte sysexJournal[] = {
            ...
            // 36 bytes
            byte emptyJournal[] = {
                0x80, 0x61, 0x00, 0x02, 0x01, 0xb0, 0xb4, 0x58, 0x12, 0xf9, 0x6d, 0x3d, // rtp
                // MIDI section
                0x62, 0x00, 0xfe, 0x80, 0x00, 0x01
            };
  ...
  0xba, 0x40, 0x00, 0x00, 0xbb, 0x40, 0x00, 0x00, 0xbc, 0x40, 0x00, 0x00, 0xbd, 0x40, 0x00, 0x0,
            ...
            byte drieBytesBrol[] = {0x01, 0x02, 0x03, 0x80, 0x61, 0x00, 0x02, 0x01, 0xb0, 0xb4, 0x58, 0x12, 0xf9, 0x6d, 0x3d, 0x62, 0x00, 0xfe, 0x80, 0x00, 0x01};
            
            write(drieBytesBrol, sizeof(drieBytesBrol));
        }
